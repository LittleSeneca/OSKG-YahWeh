...
confidence: "medium"
confidence_rationale: "Argument from 'fit' is suggestive but not decisive — the contradiction between 4:1-4 and 4:5 is genuinely striking."
claim_type: "textual"
...
**Rationale:** The argument from "fit" is suggestive but not decisive. It's possible Micah originally uttered the vision and Isaiah developed it, or both drew on a common source. The contradiction between 4:1-4 and 4:5 IS genuinely striking and supports Kaufmann's reading.

## Stakes

Which prophet originated universal eschatology. If Isaiah borrowed from Micah, the universal vision originated with the prophet who also proclaimed Jerusalem's destruction — an intriguing combination. If Micah borrowed from Isaiah, universalism originates with the prophet of Zion's inviolability.
...
**Depends on:**
- [[claim-temple-mount-vision-beginning-prophetic-universalism]] — the same vision, attributed to Isaiah

**Supports:**
- [[claim-isaiah-1-33-no-national-revenge-proves-unity]] — Isaiah's corpus has the coherent universalism that makes it the natural home for the vision
- [[claim-amos-hosea-no-universal-eschatology]] — the vision's placement in Isaiah rather than earlier prophets comports with the developmental sequence

**Contradicts:**
<!-- Will edge to claims that Micah originated the vision -->

**Challenged by:**
<!-- Will edge to post-exilic dating of both versions -->

**Primary sources:**
- Isaiah 2:2-4
- Micah 4:1-5
<!-- source-isaiah, source-micah -->
