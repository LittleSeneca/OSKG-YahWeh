...
confidence: "medium"
confidence_rationale: "High places evidence is solid across multiple sources; dead practices have strong Ugaritic parallels; child sacrifice as Yahwistic is the most contested element, resting on polemical texts."
claim_type: "textual"
...
# smith-ehg-5.1: Practices later condemned as "Canaanite idolatry" were originally acceptable Yahwistic practices

**Source:** [[Smith Chapters 5-7 — Cult, Monotheism, Portraits]] — Mark S. Smith, *The Early History of God* (1990), Chapters 5-7

## The Claim

Three categories of practice — high places, veneration of the dead, and child sacrifice (*mlk*) — were all part of Israel's Canaanite heritage and initially functioned within Yahwism without objection. They were condemned only later, as part of the differentiation process. "The religious practices of the high places were fundamentally conservative, preserving Israel's ancient religious heritage. Perhaps for this reason, many of these practices belonged also to the royal cult of Jerusalem. Yet... legal and prophetic condemnations rejected these traditional practices of Israel. In the name of the deity to whom the religion of high places was devoted, its legal and prophetic critics condemned this part of Israel's ancient religious inheritance."
...
**Practices Pertaining to the Dead:**
...
- Smith's most striking point: "Interacting with deceased ancestors was a practice that occurred among Aramaean and Israelite royalty."

**The *mlk* Sacrifice (Child Sacrifice):**
...
**Rationale:** HIGH on high places (multiple independent sources). MEDIUM-HIGH on dead practices (Ugaritic parallels + biblical evidence converge). MEDIUM on child sacrifice as Yahwistic (Jeremiah's denials imply it; Ezekiel's attribution to Yahweh is explicit, but these are polemical texts).

## Stakes

If child sacrifice was offered to Yahweh, then the God of the Bible was once understood by his own worshipers as a deity who accepted — even demanded — the burning of children. The biblical texts that deny this are later theological corrections, not original prohibitions. This is the darkest implication of Smith's book.
...
**Depends on:**
- [[claim-israelite-culture-was-canaanite-no-separation]] — Israel's culture was Canaanite, making shared practices expected
- [[claim-baal-asherah-indigenous-israelite-not-foreign-syncretism]] — practices were indigenous, not foreign imports

**Supports:**
- [[claim-convergence-differentiation-framework-israelite-religion]] — the differentiation phase explains why these practices were condemned
- [[claim-field-development-strengthened-convergence-model-since-1990]] — subsequent research has strengthened this model

**Contradicts:**
<!-- The traditional narrative that Israel always had distinct, pure worship from Sinai onward -->

**Challenged by:**
- Conservative scholars who treat biblical condemnations as the original norm
- Scholars who argue *mlk* was dedicatory ritual, not literal child sacrifice
