...
confidence: "high"
confidence_rationale: "This is the book's thesis statement, and the entire 10 chapters have built toward it. The final paragraph is quietly devastating in its descriptive power."
...
# smith-obm-10.4: Monotheism is "not a new stage of religion but a new stage of rhetoric" — later readers constructed the myth of original monotheism

**Source:** [[Smith Origins — Ch10 — Monotheism in Isaiah 40-55]] — Mark S. Smith, *The Origins of Biblical Monotheism* (2001), Chapter 10

## The Claim

"Monotheism is not a new stage of religion but a new stage of rhetoric in a situation never known prior to the threat of exile. It represents not a change of religious policy but a new formulation or interpretation of religious reality delineating along cosmic lines what was no longer well delineated in the human, political lines."
...
**Depends on:**
- [[claim-isaiah-monotheistic-statements-embedded-in-polemic]] — the contextual reading that demonstrates the rhetorical nature of monotheistic claims
- [[claim-isaiah-44-mis-pi-double-audience-judeans]] — the double-audience reading showing monotheism as intra-community consolidation
- [[claim-isaiah-44-reuses-deuteronomy-32-first-isaiah]] — the textual dependence showing monotheism as scribal phenomenon
- [[claim-monotheism-was-rhetoric-not-religious-stage]] — the Introduction's thesis that Ch10 fulfills
- [[claim-monotheism-rhetoric-inner-community-discourse]] — the Ch8 formulation that Ch10 caps
- [[claim-monotheistic-statements-exilic-late-monarchy]] — the chronological concentration in the exilic period
- [[claim-monotheism-as-transformed-canaanite-myth]] — the Ch9 demonstration of transformation as the mechanism
- [[claim-four-stage-model-monotheism-development]] — the EHG model of the long development that culminated in this rhetoric
...
- The claim that readers "construct the historical myth" is itself a historical construction
- Whether the exilic crisis is sufficient to explain the emergence of monotheistic rhetoric

**Primary sources:**
- Isaiah 40-55 (Second Isaiah)
- Deuteronomy 32
- Isaiah 13-14 (First Isaiah)
