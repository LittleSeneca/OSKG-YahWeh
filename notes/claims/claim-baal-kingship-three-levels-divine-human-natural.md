...
confidence: "high"
confidence_rationale: "The three-level reading of the Baal Cycle is persuasive and well-supported by the text; the contrast with Marduk and Yahweh as 'super-conquering gods' is particularly illuminating."
...
# smith-obm-6.4: Baal's kingship operates on three levels — divine, human, and natural — and his death encodes dynastic vulnerability

**Source:** [[Smith Origins — Ch6 — The Life and Death of Baal]] — Mark S. Smith, *The Origins of Biblical Monotheism* (2001), Chapter 6

## The Claim

"The central unifying thematic of the cycle is Baal's kingship, which affects the natural, human, and divine levels of reality." Baal's death and return "may represent a theological reflection on reality that incorporates the known conceptualization of Ugarit's monarchy." Baal is weak compared to Marduk and Yahweh who are "super-conquering gods."
...
**Rationale:** The three-level model is elegant and textually grounded. The contrast with Marduk and Yahweh is particularly illuminating — it shows that divine kingship can be portrayed as fragile (Baal) or absolute (Marduk/Yahweh), and the difference is politically significant.
...
**Depends on:**
- [[claim-cat-1-161-royal-funerary-key-baal-death]] — the ritual evidence that Baal's death was modeled on royal funerary practice
- [[claim-baals-local-manifestations-one-deity]] — the prior claim that Baal is one cosmic deity, not local manifestations

**Supports:**
<!-- Will edge to smith-obm-6.5 (Israel lacked death-conflict) — the three-level model explains WHY Baal's death was specifically Ugaritic, linked to their monarchy -->

**Contradicts:**
- Seasonal/agricultural readings of the Baal Cycle
- Frazer's nature-mythology paradigm

**Challenged by:**
- The three-level framework may be imposed rather than text-internal
- The Baal Cycle may be a compilation without a single unifying theme
