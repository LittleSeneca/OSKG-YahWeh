...
confidence: "high"
confidence_rationale: "The contextual reading of monotheistic statements is textually demonstrable. None of the verses (Isa 43:10-11; 44:6, 8; 45:5-7; 46:9) can be read in isolation as philosophical theology."
claim_type: "textual"
...
# smith-obm-10.1: Second Isaiah's monotheistic statements are polemic embedded in three thematic contexts, not abstract theology

**Source:** [[Smith Origins — Ch10 — Monotheism in Isaiah 40-55]] — Mark S. Smith, *The Origins of Biblical Monotheism* (2001), Chapter 10

## The Claim

"Monotheistic claims within this part of Isaiah are not isolated formulations like the Shema. Instead, they are embedded in a larger literary context." The context is both polemical and rhetorical — "directed to and against" the audience.
...
- Alonso Schokel: rhetoric "directed to and against." Alter: prophetic poetry's strategies are "direct accusation; satire; the monitory evocation of impending disaster" — but Isaiah 40-48 enacts REVERSAL of accusation and disaster.

## Confidence

**Rating:** high

**Rationale:** The contextual reading of monotheistic statements is textually demonstrable. None of these verses can be read in isolation as philosophical theology.

## Stakes

If monotheistic statements are polemic embedded in specific rhetorical contexts (comfort, satire, prediction), then extracting them as "doctrine of monotheism" is a category mistake. The biblical authors weren't writing systematic theology — they were trying to persuade exiled Judeans that Yahweh, not Marduk, controlled history.
...
**Depends on:**
- [[claim-monotheistic-statements-exilic-late-monarchy]] — the chronological observation that monotheistic statements cluster in the exilic period
- [[claim-monotheism-was-rhetoric-not-religious-stage]] — the rhetorical framework introduced in the Introduction that Ch10 instantiates

**Supports:**
- [[claim-monotheism-as-exilic-rhetoric-not-religious-revolution]] — the capstone thesis that Ch10's close reading demonstrates
- [[claim-isaiah-44-mis-pi-double-audience-judeans]] — the specific polemical context (mis pi ritual) that the monotheistic statements are embedded in
- [[claim-isaiah-44-reuses-deuteronomy-32-first-isaiah]] — the textual tradition that Second Isaiah draws on for its polemic
- [[claim-bible-preserves-polytheistic-traces]] — the polemical nature of monotheistic statements only makes sense against the polytheistic background Romer documents; you don't polemicize against gods you think don't exist

**Contradicts:**
<!-- Systematic theological readings that extract these verses as doctrine -->

**Challenged by:**
- Rhetoric/ontology false dichotomy: the statements make truth claims even within a rhetorical context
- Whether embeddedness in polemic negates the theological content

**Primary sources:**
- Isaiah 43:10-11
- Isaiah 44:6, 8, 9-20
- Isaiah 45:5-7, 14, 18, 21
- Isaiah 46:9
- Isaiah 40:12-31 (creator language)
