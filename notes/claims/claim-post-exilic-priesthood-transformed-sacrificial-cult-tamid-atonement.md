...
confidence_rationale: "The textual evidence for the expanded cultic system is extensive; the theological interpretation (atonement as response to 587 trauma) is Albertz's own but plausible."
...
# albertz-hir-5.8: The post-exilic priesthood transformed the sacrificial cult — expanding the tamid, creating the Day of Atonement, and making atonement theology central
...
**Rationale:** The textual evidence for the expanded cultic system is extensive (Leviticus, Numbers, Nehemiah, Mishnah). The theological interpretation (atonement as response to 587 trauma) is Albertz's own but plausible.

## Stakes

The post-exilic cult wasn't a diminished version of the First Temple cult — it was more elaborate and expensive. The Day of Atonement represents a permanent institutionalization of guilt processing: Israel could never again assume the cult automatically guaranteed divine favor. The entire system now presupposed the need for regular purification and atonement. This is the cultic counterpart to the historiographical "confession of sin" in DtrG.
...
**Depends on:**
- [[claim-ezekiel-school-cult-state-separation-priest-levite-distinction]] — the Ezekiel school's blueprint for a radically sacralized temple was the programmatic foundation the post-exilic priesthood implemented
- [[claim-exile-differential-impact-official-collapse-family-piety-survived]] — the trauma of 587 (cult failed despite functioning) is the theological rationale for the expanded atonement system

**Supports:**
- [[claim-dtrg-historiography-from-above-compromise-preserved-kingship-temple]] — the cultic atonement system is the liturgical counterpart to DtrG's historiographical "confession of sin"; both are institutionalized guilt-processing responses to the trauma of 587

**Contradicts:**
- [[claim-priestly-cult-non-pagan-silent-non-magical-awe-of-holiness]] — Albertz's economic analysis (tax burden, priestly portions) complicates Kaufmann's picture of a non-materialistic cult

**Challenged by:**
- <!-- Scholars who date Day of Atonement to pre-exilic period -->
- <!-- Reading the expanded cult as priestly economic self-interest -->

**Primary sources:**
- Leviticus 16 (Day of Atonement ritual)
- Leviticus 23.23-32 (festival calendar)
- Numbers 28-29 (sacrificial calendar)
- Nehemiah 10.33-40 (community pledges)
- Mishnah Tamid (developed liturgy)

## Assessment

This was a significant gap in the original Chapter 5 note. The cultic transformation is as important as the textual/legal transformation (Torah canonization) for understanding post-exilic religion. Albertz's linkage of atonement theology to the trauma of 587 (the cult failed once; it must never fail again) is persuasive. The economic data — "a third of total income" — is striking and explains why the temple became both the central unifying symbol AND a source of resentment.
