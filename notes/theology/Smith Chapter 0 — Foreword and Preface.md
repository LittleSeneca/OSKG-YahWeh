...
claims_files:
  ...
  - "[[claim-asherah-cult-symbol-not-goddess-monarchic-israel]]"
  - "[[claim-field-development-strengthened-convergence-model-since-1990]]"
related:
...
## Claim 1: The convergence/differentiation framework
→ [[claim-convergence-differentiation-framework-israelite-religion]] | **smith-ehg-foreword.1** | Confidence: high
  The methodological lens for the entire book: Yahweh absorbed other deities' traits (convergence) and later rejected them (differentiation). Reframes "syncretism" as internal Israelite development, not foreign contamination.
  Supports: smith-ehg-2.1, 2.2, 3.1, 3.2, 4.1, 4.2. Contradicted by: Kaufmann, Tigay, Schmid positions.

## Claim 2: Asherah was a cult symbol, not a goddess
→ [[claim-asherah-cult-symbol-not-goddess-monarchic-israel]] | **smith-ehg-foreword.2** | Confidence: medium
  Smith's minority position: the grammatical evidence favors "his asherah" (Yahweh's cult symbol) over "his Asherah" (Yahweh's consort). Majority of scholars disagree, including Dever, Day, and Zevit.
  Contradicts: romer-inv-9.3, day-ygc-2.1, day-ygc-2.3, romer-inv-9.1. Supports: smith-ehg-3.1, smith-ehg-3.2.

## Claim 3: The field has strengthened the convergence model since 1990
→ [[claim-field-development-strengthened-convergence-model-since-1990]] | **smith-ehg-foreword.3** | Confidence: medium
  Smith surveys ~40 scholars and major works (Keel/Uehlinger, Zevit, Dever) that reinforce his basic picture. Self-serving advocacy, not neutral assessment.
