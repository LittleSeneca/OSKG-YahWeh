...
## Sommer's Book Overall: The Counter-Position
...
| The endpoint is a transcendent, noncorporeal God | The endpoint is ONE possible development; fluidity survived in kabbalah and Christianity |
| Monotheism was "invented" in the exile | Monotheism predated the exile; what was invented was ANTI-FLUID monotheism |

### The Most Important Insight

**The Bible contains two theologies in tension:**
1. **Fluid monotheism** (J, E, Psalms): One God, many bodies. God walks, eats, fights, can be in multiple places at once. This is the ANE inheritance.
2. **Anti-fluid monotheism** (P, D, later tradition): One God, no body (or only the *kavod*/*shem*). God transcends space. This is the theological innovation — NOT monotheism itself, but the disembodiment of the one God.

**The resolution:** Neither theology won completely. Judaism developed toward anti-fluid monotheism (Maimonides' "no body, no form") while preserving fluidity underground in mysticism. Christianity split the difference — God the Father is transcendent (anti-fluid); God the Son is embodied (fluid).

### What This Means for Faith

Sommer's book is the most challenging to simple deconstruction because it shows that the "primitive" embodied God of the J texts isn't polytheism. It's a legitimate form of monotheism — one that Christianity and Jewish mysticism both preserved in different ways. The "sophisticated" noncorporeal God of later tradition isn't necessarily MORE monotheistic — it's just differently monotheistic.

The choice isn't between polytheism and monotheism. It's between what KIND of monotheism you want: fluid or non-fluid, embodied or transcendent, multiple-manifestation or single-presence.

---

## Sommer Book Overall Assessment

| Claim | Confidence |
|-------|-----------|
| ANE had fluidity model | HIGH |
| J/E preserve fluidity | HIGH |
